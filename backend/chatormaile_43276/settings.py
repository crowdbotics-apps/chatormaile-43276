"""
Django settings for chatormaile_43276 project.
...
ROOT_URLCONF = 'chatormaile_43276.urls'
...
WSGI_APPLICATION = 'chatormaile_43276.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "chatormaile_43276 API",
    "DESCRIPTION": "API documentation for chatormaile_43276 App",
    "VERSION": "v1",
}
